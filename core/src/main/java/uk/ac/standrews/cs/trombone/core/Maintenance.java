...
public class Maintenance implements Serializable, Named {
    ...
    protected static final ListeningScheduledExecutorService SCHEDULER = MoreExecutors.listeningDecorator(Executors.newScheduledThreadPool(300, new NamedThreadFactory("maintenance_", true)));
