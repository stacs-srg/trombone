    ...
    public static class Timer extends Sampler {
        ...
        protected CellProcessor[] getCellProcessors() {
            ...
            return new CellProcessor[] {
                    RELATIVE_TIME_IN_SECONDS_PROCESSOR, LONG_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR, NANOSECONDS_TO_MILLISECONDS_PROCESSOR,
