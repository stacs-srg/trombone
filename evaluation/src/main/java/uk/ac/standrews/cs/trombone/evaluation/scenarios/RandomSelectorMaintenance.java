 ...
 */
public class RandomSelectorMaintenance extends DisseminationStrategy implements Named {

    private static final long serialVersionUID = -5879079165256164612L;

    public RandomSelectorMaintenance(int recipient_count, int data_count) {
