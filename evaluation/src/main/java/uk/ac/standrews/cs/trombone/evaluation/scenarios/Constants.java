...
public final class Constants {
    ...
    public static final Duration EXPERIMENT_DURATION = new Duration(3, TimeUnit.MINUTES);
    ...
    public static final ZipfKeyProvider TARGET_KEY_PROVIDER = null; //new ZipfKeyProvider(20_000, 1, KEY_LENGTH_IN_BITS, SEED);
