...
public class PlatformJustificationSingleHost extends PlatformJustification {
    ...
    public PlatformJustificationSingleHost(int host_count) {
        ...
        addHost("compute-0-0.local", host_count, Constants.PORT_NUMBER_PROVIDER.copy(), Constants.NO_CHURN.copy(), Constants.WORKLOAD_1.copy(), Constants.NO_MAINTENANCE_CONFIGURATION);
    }
}
