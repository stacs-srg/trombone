 ...
 */
public class PlatformJustificationSingleHost30 extends Scenario {

    public PlatformJustificationSingleHost30() {

        super("PlatformJustificationSingleHost30", Constants.SCENARIO_MASTER_SEED);
        ...
        addHost("compute-0-0.local", 30, new SequentialPortNumberProvider(45000));
    }
}
