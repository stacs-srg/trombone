    ...
    public static void main(String[] args) throws IOException, TypeMismatchException {
        ...
        for (ScenarioAnalyzer scenarioAnalyzer : scenarioAnalyzers) {
            try (ScenarioAnalyzer scenario_analyzer = scenarioAnalyzer) {
                ...
                new AvailablePeerCountAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new EventExecutionDurationTimerAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new EventExecutionLagAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new JoinFailureRateAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new JoinSuccessRateAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupCorrectnessDelayAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupCorrectnessHopCountAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupCorrectnessRateAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupCorrectnessRetryCountAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupExecutionRateAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupFailureRateAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupIncorrectnessDelayAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupIncorrectnessHopCountAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupIncorrectnessRateAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
                new LookupIncorrectnessRetryCountAnalyzer(scenario_analyzer).saveAsSVG(destination_directory).saveAsJson(destination_directory);
