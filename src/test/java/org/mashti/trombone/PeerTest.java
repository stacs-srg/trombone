...
import uk.ac.standrews.cs.trombone.trombone.PeerState;
...
import uk.ac.standrews.cs.trombone.trombone.selector.Self;

/** @author Masih Hajiarabderkani (mh638@st-andrews.ac.uk) */
public class PeerTest {

    private final InetSocketAddress initial_address = new InetSocketAddress(0);
    private final IntegerKey peer_key = RandomIntegerKeyProvider.getDefault().get();
