 ...
 */
package org.mashti.trombone.recovery;
...
import uk.ac.standrews.cs.trombone.trombone.PeerFactory;
import uk.ac.standrews.cs.trombone.trombone.PeerReference;
import uk.ac.standrews.cs.trombone.trombone.PeerRemote;
import uk.ac.standrews.cs.trombone.trombone.selector.First;
import uk.ac.standrews.cs.trombone.trombone.selector.Last;
...
class RingSizeScanner extends AbstractScanner {
    ...
    public static int cycleLengthFrom(final PeerReference application_reference, final boolean forwards) throws InterruptedException {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                node = forwards ? proxy.pull(First.getInstance(), 1)[0] : proxy.pull(Last.getInstance(), 1)[0];
            }
